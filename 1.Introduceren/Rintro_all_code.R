...
read_csv("H:/RIntroductie/RHarvard/Rintro/dataSets/babyNames.csv", n_max = 10)

## specify column types in the col_types argument
read_csv("H:/RIntroductie/RHarvard/Rintro//dataSets/babyNames.csv", n_max = 10, col_types = "??c????????????")

## read all the data
baby.names <- read_csv("H:/RIntroductie/RHarvard/Rintro/dataSets/babyNames.csv", col_types = "??c????????????")
...
load("H:/RIntroductie/RHarvard/Rintro/myWorkspace.RData") # load myWorkspace.RData
ls() # list objects
